...
:::note
`ClimateEntity` has built-in validation to ensure that the target low temperature is lower than or equal to the target high temperature. Therefore, integrations do not need to validate this in their own implementation.
:::
